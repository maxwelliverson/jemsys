...
#ifndef JEMSYS_AGATE_SPMC_MAILBOX_H
#define JEMSYS_AGATE_SPMC_MAILBOX_H
...
JEM_api agt_message_t JEM_stdcall agt_finish_send_message_spmc_dynamic(agt_mailbox_t mailbox, jem_size_t messageSize, void* messagePayload);
...
#endif//JEMSYS_AGATE_SPMC_MAILBOX_H
