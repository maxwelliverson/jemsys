...
JEM_api agt_status_t JEM_stdcall agt_finish_send_message_spsc(agt_mailbox_t mailbox, agt_message_t* pMessage, void* messagePayload, agt_send_message_flags_t flags);
