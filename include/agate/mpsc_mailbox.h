...
JEM_api agt_message_t JEM_stdcall agt_finish_send_message_mpsc(agt_mailbox_t mailbox, jem_size_t messageSize, void* messagePayload);
...
JEM_api agt_message_t JEM_stdcall agt_finish_send_message_mpsc_dynamic(agt_mailbox_t mailbox, jem_size_t messageSize, void* messagePayload);
