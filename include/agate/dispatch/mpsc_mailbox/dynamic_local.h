...
JEM_api void                JEM_stdcall agt_dynamic_local_mpsc_mailbox_send_many(agt_handle_t handle, jem_size_t messageCount, void** messageSlots, agt_message_t* messages, agt_send_message_flags_t flags) JEM_noexcept;
...
JEM_api void                JEM_stdcall agt_dynamic_local_mpsc_mailbox_query_attributes(agt_handle_t handle, jem_size_t attributeCount, const agt_handle_attribute_kind_t* attributeKinds, agt_handle_attribute_t* attributes) JEM_noexcept;
