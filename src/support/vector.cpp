...
JEM_noreturn static void report_size_overflow(jem_u64_t minimum_size, jem_u64_t maximum_size)  {
...
/// std::length_error or calls report_fatal_error.
JEM_noreturn static void report_at_maximum_capacity(jem_u64_t maximum_size)  {
  std::string Reason =
