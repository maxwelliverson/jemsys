...
namespace ipc{
  ...
  enum process_extra_arg_kind{
    process_arg_process_security,
    process_arg_thread_security,
    process_arg_inherit_handle,
    process_arg_environment,
    process_arg_current_directory,
    process_arg_thread_id,
    process_arg_thread_handle
  };

  struct process_extra_arg{
    process_extra_arg_kind kind;
    uintptr_t              value;
  };
  ...
  public:
    ...
    static std::optional<process> launch(const char* applicationName, char* commandLineOpts, std::span<process_extra_arg> extraArgs = {});
    static std::optional<process> launch_child(const char* applicationName, char* commandLineOpts, std::span<process_extra_arg> extraArgs = {});
