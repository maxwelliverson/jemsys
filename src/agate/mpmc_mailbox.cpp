...
agt_status_t JEM_stdcall agt::impl::local_mpmc_try_operation(agt_mailbox_t mailbox_, mailbox_role_t role, mailbox_op_kind_t opKind, jem_u64_t timeout_us) noexcept {
  switch (opKind) {
...
agt_mailslot_t    JEM_stdcall impl::local_mpmc_acquire_slot(agt_mailbox_t mailbox_, jem_size_t slot_size, jem_u64_t timeout_us) JEM_noexcept {
...
/*void          JEM_stdcall impl::local_mpmc_release_slot(agt_mailbox_t mailbox_, agt_mailslot_t slot) JEM_noexcept {
...
agt_signal_t  JEM_stdcall impl::local_mpmc_send(agt_mailbox_t mailbox_, agt_mailslot_t slot, agt_send_flags_t flags) JEM_noexcept {
...
agt_status_t JEM_stdcall impl::shared_mpmc_try_operation(agt_mailbox_t mailbox_, mailbox_role_t role, mailbox_op_kind_t opKind, jem_u64_t timeout_us) noexcept {
  return AGT_ERROR_NOT_YET_IMPLEMENTED;
}


agt_mailslot_t    JEM_stdcall impl::shared_mpmc_acquire_slot(agt_mailbox_t mailbox_, jem_size_t slot_size, jem_u64_t timeout_us) JEM_noexcept {
  return nullptr;
}

agt_signal_t  JEM_stdcall impl::shared_mpmc_send(agt_mailbox_t mailbox_, agt_mailslot_t slot, agt_send_flags_t flags) JEM_noexcept {
  return nullptr;
}
